...
export class TransferComponent implements OnInit {
  ...
  acquirer = new FormControl('', Validators.required);
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: 'org.example.mynetwork.Transfer',
      'transferId': this.transferId.value,
      'description': this.description.value,
      'amount': this.amount.value,
      'acquirer': this.acquirer.value
    };
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.acquirer) {
        formObject.acquirer = result.acquirer;
      } else {
        formObject.acquirer = null;
      }
